          ...
          {view === 'onboarding' && (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button onClick={handleLogin} className="w-full sm:w-auto px-8 py-4 text-lg">
                  Começar Agora <ChevronRight size={20} />
                </Button>
                <Button onClick={() => setView('plans')} variant="outline" className="w-full sm:w-auto px-8 py-4 text-lg">
                  Ver Planos
                </Button>
              </div>
